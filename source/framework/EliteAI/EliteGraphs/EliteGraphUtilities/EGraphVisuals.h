...
const Elite::Color HIGHLIGHTED_NODE_COLOR{ 0.8f, 0.8f, 0.8f };
const Elite::Color START_NODE_COLOR{ 0.f, 1.0f, 0.0f };
const Elite::Color END_NODE_COLOR_BLUE{ 0.f, 1.f, 1.f };
const Elite::Color END_NODE_COLOR_RED{ 1.f, 0.f, 0.f };
